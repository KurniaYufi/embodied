...
<div class="flex flex-col gap-6">
                ...
                <flux:table.row wire:key="product-{{ $product->id }}">
                    ...
                    <flux:table.cell>
                        <div class="flex justify-end gap-2">
                            ...
                            <flux:button size="sm" variant="ghost" wire:click="delete({{ $product->id }})" wire:confirm="Delete this product?">Delete</flux:button>
                        </div>
                    </flux:table.cell>
                </flux:table.row>
            @empty
    ...
    <flux:modal name="product-form" class="w-full max-w-2xl">
        <form wire:submit="save" class="space-y-6">
            ...
            <div>
                <label for="product-photo" class="mb-2 block text-sm font-medium">Product Photo</label>
                <input
                    id="product-photo"
                    type="file"
                    wire:model="photo"
                    accept="image/*"
                    class="block w-full text-sm text-neutral-600 file:mr-4 file:border-0 file:bg-neutral-900 file:px-4 file:py-2 file:text-xs file:tracking-[0.15em] file:text-white file:uppercase"
                >
                <div wire:loading wire:target="photo" class="mt-2 text-xs text-neutral-500">Uploading…</div>
            ...
            <div>
                <flux:checkbox.group wire:model="sizeIds" label="Available Sizes">
